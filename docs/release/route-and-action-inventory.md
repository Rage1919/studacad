...
| `/tutors/[slug]`          | Read approved tutor profile, message, favourite, report, choose a slot, book                              | Stable public URL backed by the approved marketplace view; booking, messaging, availability, and account mutations remain server-authoritative                                                          |
...
| `/courses`                | Browse published revision courses                                                                         | Published course records only; explicit empty and unavailable states                                                                                                                                    |
| `/courses/[slug]`         | Read published course description and lesson outline; open My learning                                    | Stable public URL backed only by published course and lesson metadata; protected content and purchase entitlement remain private                                                                        |
