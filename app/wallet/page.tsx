...
export default function WalletPage() {
  ...
  return <main className="lms-page wallet-page">
    ...
    <section className="wallet-hero"><div><p className="eyebrow">Studacad wallet</p><h1>{credits.toLocaleString()} <span>credits</span></h1><p>Use credits to book subject tutors, unlock exam-preparation courses, and access revision resources.</p></div><div className="wallet-card"><span>Studacad</span><i>◆</i><small>Available balance</small><strong>{credits.toLocaleString()} CR</strong><b>•••• 2840</b></div></section>
