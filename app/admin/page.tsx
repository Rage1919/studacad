...
export default function AdminPage() {
  ...
  return <main className="lms-page admin-page">
    ...
    <div className="admin-tabs" role="tablist"><button className={tab === "lesson" ? "active" : ""} onClick={() => setTab("lesson")}>＋ New lesson</button><button className={tab === "course" ? "active" : ""} onClick={() => setTab("course")}>＋ New course</button><button className={tab === "library" ? "active" : ""} onClick={() => setTab("library")}>Content library</button><Link className="admin-review-link" href="/admin/wallet">Record deposit →</Link><Link className="admin-review-link" href="/admin/tutor-applications">Tutor verification →</Link></div>
