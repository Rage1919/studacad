...
import { EMAIL_LINK_RESPONSE, normalizeEmail, safeReturnPath } from "../../../../server/auth/auth-policy.mjs";
...
export async function POST(request: Request) {
  ...
  return Response.json(EMAIL_LINK_RESPONSE, { status: 202, headers: responseHeaders });
}
