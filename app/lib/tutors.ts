...
const subjectTutor = (seed: TutorSeed): Tutor => ({
  ...
  specialties: [
    `${seed.subject} foundations`,
    "Structured questions",
    "Exam technique",
    "Revision planning",
  ],
  approach: [
    "Identify the learner's priority topics",
    "Explain with worked examples",
    `Practise ${seed.examination}-style questions`,
    "Finish with feedback and a revision task",
  ],
  sessionFormats: [
    "online-1to1",
    "online-group",
  ...
  resume: {
    ...
    experience: [
      {
        role: `${seed.examination} ${seed.subject} Tutor`,
        organisation: "Studacad",
        period: "2021–present",
      },
      {
        role: `${seed.subject} Classroom Teacher`,
        organisation: "Botswana",
        period: "2019–present",
      },
    ],
    certifications: [
      "Botswana Teaching Council registered",
      "Child safeguarding",
...
export const tutors: Tutor[] = [
  {
    ...
    headline:
      "Patient PSLE Mathematics support with clear, step-by-step explanations.",
    about:
      "I help PSLE learners turn difficult Mathematics topics into manageable steps. Lessons focus on computation, application, reasoning, and the confidence to show complete working in an examination.",
    specialties: [
    ...
    approach: [
      "Begin with a short skills check",
      "Explain one method at a time",
      "Practise with PSLE-style questions",
      "Finish with a revision task and checkpoint",
    ],
    availability: [
      "Today · 17:00",
      "Tomorrow · 16:30",
  ...
  },
  {
    ...
    about:
      "My tutorials connect Biology, Chemistry, and Physics concepts to familiar situations. Learners practise scientific vocabulary, diagrams, explanations, and data interpretation so they can answer JCE questions precisely.",
    specialties: [
      "Cells & body systems",
      "Matter & particles",
      "Forces & energy",
    ...
    approach: [
      "Identify the learner's weakest topic",
      "Use diagrams and real-world examples",
      "Model a complete examination answer",
      "Check retention with multiple-choice questions",
    ],
    availability: [
      "Today · 18:00",
      "Thu · 17:30",
    ...
    resume: {
      ...
      experience: [
        {
          role: "JCE General Science Tutor",
          organisation: "Studacad",
          period: "2020–present",
        },
        {
          role: "Science Department Lead",
          organisation: "Francistown",
          period: "2017–2024",
        },
      ],
      certifications: [
  ...
  },
  {
    ...
    headline:
      "Precise BGCSE Biology explanations, diagrams, and exam practice.",
    about:
      "I help BGCSE learners organise Biology content and write answers that use the correct scientific terms. Every tutorial combines concept review, labelled diagrams, structured questions, and targeted revision.",
    specialties: [
      "Cell biology",
    ...
    approach: [
      ...
      "Build accurate scientific vocabulary",
      "Practise structured BGCSE responses",
  ...
  subjectTutor({
    ...
    availability: ["Today · 19:00", "Wed · 16:00", "Sat · 12:00"],
    availabilityGroups: ["Today", "Weekdays", "Weekend"],
  }),
  subjectTutor({
    id: "naledi",
  ...
  subjectTutor({
    ...
    availability: ["Today · 16:00", "Tomorrow · 18:00", "Sat · 09:30"],
    availabilityGroups: ["Today", "Tomorrow", "Weekend"],
  }),
  subjectTutor({
    id: "boitumelo",
    ...
    availability: ["Tomorrow · 17:30", "Fri · 16:30", "Sun · 12:00"],
    availabilityGroups: ["Tomorrow", "Weekdays", "Weekend"],
  }),
  subjectTutor({
    id: "lorato",
    ...
    color: "peach",
    image:
      "https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?auto=format&fit=crop&w=900&q=88",
    location: "Palapye, Botswana",
    availability: ["Today · 18:30", "Tomorrow · 16:00", "Sat · 11:00"],
    availabilityGroups: ["Today", "Tomorrow", "Weekend"],
  }),
  subjectTutor({
    id: "tumelo",
    ...
    location: "Maun, Botswana",
    availability: ["Tomorrow · 18:00", "Thu · 16:30", "Sun · 14:30"],
    availabilityGroups: ["Tomorrow", "Weekdays", "Weekend"],
  }),
  subjectTutor({
    id: "phenyo",
    ...
    availability: ["Today · 17:30", "Fri · 17:00", "Sat · 10:30"],
    availabilityGroups: ["Today", "Weekdays", "Weekend"],
  }),
  subjectTutor({
    id: "onalenna",
  ...
  subjectTutor({
    ...
    location: "Francistown, Botswana",
    availability: ["Today · 20:00", "Wed · 17:30", "Sun · 11:00"],
    availabilityGroups: ["Today", "Weekdays", "Weekend"],
  }),
  subjectTutor({
    id: "dineo",
    ...
    color: "yellow",
    image:
      "https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=900&q=88",
    location: "Gaborone, Botswana",
    availability: ["Tomorrow · 16:30", "Fri · 18:30", "Sat · 13:00"],
    availabilityGroups: ["Tomorrow", "Weekdays", "Weekend"],
  }),
  subjectTutor({
    id: "goitse",
    ...
    color: "blue",
    image:
      "https://images.unsplash.com/photo-1506277886164-e25aa3f4ef7f?auto=format&fit=crop&w=900&q=88",
    location: "Mahalapye, Botswana",
    availability: ["Today · 18:00", "Tomorrow · 17:00", "Sun · 15:00"],
    availabilityGroups: ["Today", "Tomorrow", "Weekend"],
  }),
  subjectTutor({
    id: "tshegofatso",
    ...
    location: "Gaborone, Botswana",
    availability: ["Tomorrow · 18:30", "Thu · 17:00", "Sat · 14:00"],
    availabilityGroups: ["Tomorrow", "Weekdays", "Weekend"],
  }),
  subjectTutor({
    id: "olebile",
    ...
    color: "yellow",
    image:
      "https://images.unsplash.com/photo-1519345182560-3f2917c472ef?auto=format&fit=crop&w=900&q=88",
    location: "Kasane, Botswana",
    availability: ["Today · 16:30", "Fri · 18:00", "Sun · 09:00"],
    availabilityGroups: ["Today", "Weekdays", "Weekend"],
  }),
  subjectTutor({
    id: "lesego",
    ...
    location: "Gaborone, Botswana",
    availability: ["Tomorrow · 17:30", "Thu · 19:00", "Sat · 15:00"],
    availabilityGroups: ["Tomorrow", "Weekdays", "Weekend"],
  }),
];

export const findTutor = (id: string) =>
  tutors.find((tutor) => tutor.id === id);
