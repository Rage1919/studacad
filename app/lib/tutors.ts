...
export const tutors: Tutor[] = [
  {
    ...
    about: "I help PSLE learners turn difficult Mathematics topics into manageable steps. Lessons focus on computation, application, reasoning, and the confidence to show complete working in an examination.",
  ...
  },
  {
    ...
    about: "I help BGCSE learners organise Biology content and write answers that use the correct scientific terms. Every tutorial combines concept review, labelled diagrams, structured questions, and targeted revision.",
